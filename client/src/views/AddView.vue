...
<template>
  <div class="flex flex-col min-h-screen min-w-screen">
    ...
    <form class="lg:max-w-lg md:max-w-sm mx-auto p-10 w-dvw">
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <textarea id="note_text" rows="9" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 resize-none" placeholder="Enter the note context..."></textarea>
        </div>
